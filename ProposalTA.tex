...
\begin{center}
    ...
    {\Large\bfseries EKSPLORASI DAN IMPLEMENTASI ALGORITMA FACE RECOGNITION DENGAN ONE-SHOT LEARNING UNTUK PENCARIAN OTOMATIS FOTO PRIBADI BERDASARKAN SELFIE}\\
     \vspace{4cm}
