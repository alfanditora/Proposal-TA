\begin{table}[H]
  ...
  \begin{tabular}{ | p{2cm} | p{3cm} | p{7cm} |}
	...
	NF4	& \textit{Scalability} & Sistem harus mampu memproses masukan dataset dalam jumlah besar (minimal 500 - 1.000 foto) dalam satu kali eksekusi tanpa mengalami kegagalan memori \\ \hline
	\end{tabular}
