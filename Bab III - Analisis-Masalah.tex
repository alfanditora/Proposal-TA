...
\begin{figure}[h] % pilihan opsi yang disarankan: t = top, b = bottom, h = here
  ...
  \captionsetup{justification=centering}
    	\includegraphics[width=0.7\textwidth]{image/PB-Pencarian Foto.png}
	\caption{Alur Pencarian Foto dari Ruang Renyimpanan}
...
\begin{enumerate}
    ...
    \item \textbf{Pendekatan Berbasis Atribut atau Objek Semantik} \\
...
Analisis antara peluang teknologi dapat dilihat dengan rangkum dan terstruktur di Tabel \ref{tbl:alternatif_solusi}

\input{table/alternatif.tex}

Berdasarkan hasil analisis, pendekatan berbasis \textit{face recognition} adalah solusi yang paling relevan dan efektif karena kelebihan utamanya terletak pada kemampuan untuk melakukan identifikasi spesifik individu. Meskipun memerlukan komputasi yang lebih tinggi, metode ini secara langsung menjawab tujuan sistem untuk menyaring dan mengelompokkan foto berdasarkan identitas wajah pengguna. Oleh karena itu, eksplorasi selanjutnya akan difokuskan pada penentuan algoritma \textit{face recognition} yang paling akurat untuk mengatasi variasi kondisi foto.
